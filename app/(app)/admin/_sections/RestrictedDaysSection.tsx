...
import { createRestrictedAction, deleteRestrictedAction } from "../restricted-days/actions";

// Restricted / blackout periods when leave can't be booked, scoped to company, region
// or department. Enforced at request time by the existing server actions.
export default async function RestrictedDaysSection() {
