  ...
  return (
    <div style={{ maxWidth: 820 }}>
      ...
      <p className="t-muted" style={{ marginBottom: "var(--space-5)" }}>
        Editable data — no deploy needed. Branding, notification settings and multi-level approval routing are deferred
        (see project notes). Regional weekends/holidays live under <a href="/admin/calendars">Regional calendars</a>.
      </p>
